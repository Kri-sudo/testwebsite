         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">status</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-info"><a href="<?php echo base_url(); ?>status/status_report" class="text-white"><i class="" aria-hidden="true"></i> status Report </a></button>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="Get_status_data_for_report" class="form-material row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <select class="form-control custom-select"  tabindex="1" name="em_id" id="employee_id" required>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Full status</h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#getAtdReport").click(function(e) {
            ...
            $.ajax({
                url: 'Get_status_data_for_report',
                method: 'POST',
                data: {
                    date_from: date_from,
                    date_to: date_to,
